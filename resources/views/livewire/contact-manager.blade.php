                ...
                <div class="bg-black/20 border border-dark-border rounded-[32px] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl">
                    ...
                    @if($isEditingGroup)
                        <div class="mt-4 space-y-2">
                            <input type="text" wire:model.defer="groupName" placeholder="{{ __('Guruh nomi (Masalan: Haydovchilar)') }}" class="w-full bg-black/40 border border-dark-border rounded-xl px-3 py-2 text-white text-sm focus:border-accent outline-none">
                                ...
                                <div class="bg-white/5 border border-white/10 rounded-2xl p-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" wire:model="newFieldName" placeholder="{{ __('Masalan: Mashina turi') }}" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none">
                                        ...
                                        @if($newFieldType === 'select')
                                            <div class="md:col-span-2">
                                                ...
                                                <input type="text" wire:model="newFieldOptions" placeholder="{{ __('Damas, Cobalt, Gentra, Tracker') }}" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none">
                                            </div>
                                        @endif
