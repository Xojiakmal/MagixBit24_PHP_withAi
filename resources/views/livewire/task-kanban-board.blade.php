<div class="h-full bg-transparent text-white pb-10">
    <div>
        ...
        <x-slide-over wire:model="isCreatingTask" id="createTaskPanel" title="Yangi vazifa qo'shish" maxWidth="6xl">
            <x-slot:actions>
                ...
                <div class="w-full lg:w-1/3 p-6 bg-black/20 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        @if($newTaskAssignType === 'user')
                            <div>
                                ...
                                @livewire('search-dropdown', ['model' => 'App\Models\User', 'searchFields' => ['name', 'phone', 'address'], 'eventName' => 'assigneeSelected', 'placeholder' => 'Ism, telefon raqam yoki manzilni yozing...'])
                        ...
                        @elseif($newTaskAssignType === 'team')
                            <div>
                                ...
                                @endphp
                                @livewire('search-dropdown', ['model' => 'App\Models\Team', 'searchField' => 'name', 'eventName' => 'teamSelected', 'placeholder' => 'Jamoa qidirish...'])
                    ...
                    <div class="pt-6 border-t border-white/10 space-y-4">
                        <div>
                            ...
                            @livewire('search-dropdown', ['model' => 'App\Models\User', 'searchFields' => ['name', 'phone', 'address'], 'eventName' => 'observerSelected', 'placeholder' => 'Kuzatuvchi qidirish (Ism, Tel, Manzil)...'])
