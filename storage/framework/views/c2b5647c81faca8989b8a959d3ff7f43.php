        ...
        <?php else: ?>
            ...
            <div class="bg-black/20 isolate border border-dark-border p-8 rounded-[32px] shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <form action="<?php echo e(route('storage.upload')); ?>" method="POST" enctype="multipart/form-data" class="flex items-center space-x-4">
                        <?php echo csrf_field(); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($files->count() > 0): ?>
                    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="bg-black/20 p-4 rounded-2xl border border-white/5 hover:border-accent/50 transition-all group">
                                ...
                                <p class="text-xs text-dark-muted mt-1"><?php echo e(number_format($file->file_size / 1024 / 1024, 2)); ?> MB • <?php echo e($file->uploader->name ?? 'Tizim'); ?></p>
                            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/resources/views/storage/index.blade.php ENDPATH**/ ?>