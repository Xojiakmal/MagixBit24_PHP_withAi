<div>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-bold text-2xl text-white tracking-tight">
            <?php echo e(__('Kompaniya Ombri (Storage)')); ?>
    ...
    <div class="h-full space-y-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$tenant->storage_chat_id): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->hasRole('Admin') || Auth::user()->id === $tenant->owner_id): ?>
                <div class="bg-black/20 isolate border border-dark-border p-8 rounded-[32px] shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl max-w-3xl">
                    <h3 class="text-xl font-bold text-white mb-4"><?php echo e(__('Storage tizimini sozlash')); ?></h3>
                    <div class="text-gray-300 space-y-4 mb-8 text-sm">
                        <p><?php echo __('Fayllarni markazlashgan holda saqlash uchun Telegram Yopiq Guruhini (Private Group) tizimga ulashingiz kerak:'); ?></p>
                        <ol class="list-decimal pl-5 space-y-2 text-accent">
                            <li><?php echo __('Telegramda yangi <b>Yopiq guruh (Private Group)</b> yarating.'); ?></li>
                            <li><?php echo __('Tizim botini (<span class="text-white font-mono">:bot</span>) shu guruhga qo\'shing.', ['bot' => '@' . env('TELEGRAM_BOT_USERNAME', 'WipeBitrixBot')]); ?></li>
                            <li><?php echo __('Botga guruhda <b>Admin</b> huquqlarini bering.'); ?></li>
                            <li><?php echo __('Guruhga quyidagi maxsus buyruqni yuboring:'); ?></li>
                        </ol>
                        ...
                        <div class="mt-4 p-4 bg-black/40 border border-dark-border rounded-xl">
                            <p class="text-white font-mono text-center text-lg select-all cursor-pointer">
                                /setstorage <?php echo e($tenant->unique_link); ?>
            ...
            <?php else: ?>
                <div class="bg-black/20 isolate border border-dark-border p-8 rounded-[32px] shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl max-w-3xl">
                    <p class="text-gray-300"><?php echo e(__('Kompaniya rahbari hali Storage tizimini sozlamagan. Iltimos kuting.')); ?></p>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php else: ?>
            <!-- File Manager -->
            <div class="bg-black/20 isolate border border-dark-border p-8 rounded-[32px] shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl">
                <div class="flex justify-between items-center mb-6">
                    <div class="flex items-center space-x-2 text-white/80">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <span>/</span>
                            <button wire:click="openFolder(<?php echo e($breadcrumb->id); ?>)" class="hover:text-accent transition-colors truncate max-w-[150px]">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->can('manage_storage') || Auth::user()->hasRole('Admin')): ?>
                    <div class="flex items-center space-x-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCreatingFolder): ?>
                            <div class="flex items-center space-x-2">
                                <input type="text" wire:model.defer="newFolderName" placeholder="<?php echo e(__('Papka nomi')); ?>" class="bg-black/40 border border-dark-border rounded-xl text-white px-3 py-1.5 text-sm focus:outline-none focus:border-accent w-40">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <label for="fileUpload" class="inline-flex items-center px-4 py-2 text-sm font-semibold rounded-xl text-white bg-accent hover:bg-accent-hover shadow-[0_0_15px_rgba(155,114,255,0.4)] transition-all cursor-pointer">
                                ...
                                <?php echo e(__('Fayl tanlash')); ?>

                            </label>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fileToUpload): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($folders->count() == 0 && $files->count() == 0): ?>
                    <div class="text-center py-12 border-2 border-dashed border-dark-border rounded-2xl">
                        ...
                        <h3 class="mt-2 text-sm font-semibold text-white"><?php echo e(__('Bo\'sh ombor')); ?></h3>
                        <p class="mt-1 text-sm text-dark-muted"><?php echo e(__('Bu papkada hech narsa yo\'q.')); ?></p>
                    </div>
                <?php else: ?>
                    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        <!-- Folders -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="bg-black/20 p-4 rounded-2xl border border-white/5 hover:border-accent/50 transition-all group relative cursor-pointer overflow-hidden" wire:click="openFolder(<?php echo e($folder->id); ?>)">
                                ...
                                <div class="flex items-center space-x-3 mb-2">
                                    ...
                                    <h4 class="text-white font-medium truncate text-sm flex-1"><?php echo e($folder->name); ?></h4>
                                    
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->can('manage_storage') || Auth::user()->hasRole('Admin')): ?>
                                    <button wire:click.stop="deleteFolder(<?php echo e($folder->id); ?>)" class="opacity-0 group-hover:opacity-100 text-red-400 hover:text-red-300 transition-opacity p-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="bg-black/20 p-4 rounded-2xl border border-white/5 hover:border-accent/50 transition-all group relative overflow-hidden">
                                ...
                                <div class="h-32 bg-dark-bg/50 rounded-xl mb-4 flex items-center justify-center relative">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_starts_with($file->file_type, 'image/')): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRenamingFile && $renamingFileId == $file->id): ?>
                                ...
                                <?php else: ?>
                                    <h4 class="text-white font-medium truncate text-sm" title="<?php echo e($file->file_name); ?>"><?php echo e($file->file_name); ?></h4>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="flex items-center justify-between mt-2">
                                    <p class="text-xs text-dark-muted"><?php echo e(number_format($file->file_size / 1024 / 1024, 2)); ?> MB</p>
                                    
                                    <div class="flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button wire:click="downloadFile(<?php echo e($file->id); ?>)" class="text-blue-400 hover:text-blue-300" title="<?php echo e(__('Yuklab olish')); ?>">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                        </button>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->can('manage_storage') || Auth::user()->hasRole('Admin')): ?>
                                        <button wire:click="startRenamingFile(<?php echo e($file->id); ?>, '<?php echo e(addslashes($file->file_name)); ?>')" class="text-yellow-400 hover:text-yellow-300" title="<?php echo e(__('Nomini o\'zgartirish')); ?>">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                        </button>
                                        <button wire:click="deleteFile(<?php echo e($file->id); ?>)" class="text-red-400 hover:text-red-300" title="<?php echo e(__('O\'chirish')); ?>">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                        </button>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
...
<?php /**PATH /var/www/resources/views/livewire/storage-manager.blade.php ENDPATH**/ ?>