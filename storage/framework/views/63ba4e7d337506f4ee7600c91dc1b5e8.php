<div wire:poll.5s class="mt-8">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('Admin')): ?>
        <div class="mb-6 bg-black/20 border border-dark-border p-4 rounded-2xl flex items-center justify-between">
            <div>
                <h4 class="text-white font-semibold"><?php echo e(__('Tarixni qayta tiklash')); ?></h4>
                <p class="text-xs text-dark-muted"><?php echo e(__('Storage\'dan yuklab olingan .json/.log faylni yuklab, eski ma\'lumotlarni tiklang')); ?></p>
            </div>
            <div class="flex items-center space-x-4">
                ...
                <button wire:click="restoreLogs" class="px-4 py-2 bg-accent hover:bg-accent-hover text-white text-sm font-semibold rounded-xl shadow-[0_0_15px_rgba(155,114,255,0.4)] transition-colors" wire:loading.attr="disabled"><?php echo e(__('Tiklash')); ?></button>
            </div>
        </div>
    ...
    <div class="bg-black/20 isolate border border-dark-border p-6 rounded-[32px] shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl relative overflow-hidden group">
        ...
        <div class="flex justify-between items-center mb-6">
            <h3 class="text-xl font-bold text-white flex items-center">
                ...
                <?php echo e(__('Xodimlar Faoliyati')); ?>

            </h3>
            <button wire:click="expandActivity" class="p-2 bg-white/5 hover:bg-white/10 rounded-xl transition-colors text-gray-400 hover:text-white" title="<?php echo e(__('Kattalashtirish')); ?>">
        ...
        <div class="space-y-4 max-h-80 overflow-y-auto custom-scrollbar pr-2">
                ...
                <div class="flex space-x-3 items-start border-l-2 border-accent/30 pl-4 py-1 relative">
                    ...
                    <div>
                        <p class="text-sm text-gray-300">
                            <strong class="text-white"><?php echo e($activity->user->name ?? __('Tizim')); ?></strong> 
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activity->action == 'created'): ?> <?php echo e(__('yaratdi')); ?>

                            <?php elseif($activity->action == 'deleted'): ?> <?php echo e(__('o\'chirdi')); ?>

                            <?php elseif($activity->action == 'assigned'): ?> <?php echo e(__('biriktirdi')); ?>

                            <?php elseif($activity->action == 'status_changed'): ?> <?php echo e(__('holatini o\'zgartirdi')); ?>

                            <?php else: ?> <?php echo e(__('amalini bajardi')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                <p class="text-gray-500 text-sm text-center"><?php echo e(__('Hech qanday faoliyat mavjud emas.')); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    ...
    <div class="bg-black/20 isolate border border-dark-border p-6 rounded-[32px] shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl relative overflow-hidden group">
        ...
        <div class="flex justify-between items-center mb-6">
            <h3 class="text-xl font-bold text-white flex items-center">
                ...
                <?php echo e(__('O\'zgarishlar Tarixi')); ?>

            </h3>
            <button wire:click="expandHistory" class="p-2 bg-white/5 hover:bg-white/10 rounded-xl transition-colors text-gray-400 hover:text-white" title="<?php echo e(__('Kattalashtirish')); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4"></path></svg>
            </button>
        </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="bg-white/5 p-3 rounded-xl border border-white/5">
                    <div class="flex justify-between mb-2">
                        <p class="text-sm font-semibold text-white"><?php echo e($hist->user->name ?? __('Tizim')); ?></p>
                        <span class="text-xs text-dark-muted"><?php echo e($hist->created_at->diffForHumans()); ?></span>
                    </div>
                    <p class="text-xs text-gray-400 mb-2">
                        <?php echo e(__('Obyekt:')); ?> <span class="text-blue-400"><?php echo e(class_basename($hist->subject_type)); ?> #<?php echo e($hist->subject_id); ?></span>
                    </p>
                    <div class="bg-black/30 rounded-lg p-2 text-xs font-mono break-words space-y-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($changesCount > 2): ?>
                            <div class="text-dark-muted text-[10px] mt-1 italic">+ <?php echo e(__('yana')); ?> <?php echo e($changesCount - 2); ?> <?php echo e(__('ta o\'zgarish')); ?></div>
                        <?php elseif($changesCount === 0): ?>
                            <div class="text-gray-500 text-xs"><?php echo e(__('Hech qanday ko\'rsatiladigan o\'zgarish yo\'q')); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                <p class="text-gray-500 text-sm text-center"><?php echo e(__('Tarix bo\'sh.')); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        </div>
    </div>
                        ...
                        <div class="flex-1">
                            <div class="flex justify-between">
                                <p class="text-base text-gray-200">
                                    <strong class="text-white"><?php echo e($activity->user->name ?? __('Tizim')); ?></strong> 
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activity->action == 'created'): ?> <?php echo e(__('yangi ma\'lumot yaratdi')); ?>

                                    <?php elseif($activity->action == 'deleted'): ?> <?php echo e(__('ma\'lumotni o\'chirdi')); ?>

                                    <?php elseif($activity->action == 'assigned'): ?> <?php echo e(__('xodim biriktirdi')); ?>
                            ...
                            <p class="text-sm text-accent mt-1"><?php echo e(__('Obyekt turi:')); ?> <?php echo e(class_basename($activity->subject_type)); ?> | <?php echo e(__('Obyekt ID:')); ?> <?php echo e($activity->subject_id); ?></p>
                        </div>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
            ...
            <div class="bg-black/20 border border-dark-border rounded-xl overflow-hidden">
                <table class="w-full text-left text-sm text-gray-300">
                    <thead class="bg-black/40 text-xs uppercase text-gray-400">
                        <tr>
                            <th class="px-6 py-4 font-semibold w-1/6"><?php echo e(__('Sana va Vaqt')); ?></th>
                            <th class="px-6 py-4 font-semibold w-1/6"><?php echo e(__('Xodim')); ?></th>
                            <th class="px-6 py-4 font-semibold w-1/6"><?php echo e(__('Obyekt')); ?></th>
                            <th class="px-6 py-4 font-semibold w-1/2"><?php echo e(__('O\'zgarishlar (Eski -> Yangi)')); ?></th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-dark-border/50">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="hover:bg-white/5 transition-colors">
                                ...
                                <td class="px-6 py-4 font-medium text-white"><?php echo e($hist->user->name ?? __('Tizim')); ?></td>
