        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-black/20 isolate border border-dark-border p-6 rounded-[32px] shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    <p class="text-sm font-medium text-dark-muted mb-2"><?php echo e(__('Jarayondagi pul')); ?></p>
                    <h3 class="text-3xl font-bold text-white tracking-tight">$<?php echo e(number_format($inProgressRevenue, 0, '.', ' ')); ?></h3>
                </div>
            ...
            <div class="bg-black/20 isolate border border-dark-border p-6 rounded-[32px] shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    <p class="text-sm font-medium text-dark-muted mb-2"><?php echo e(__('Yopilgan pul')); ?></p>
                    <h3 class="text-3xl font-bold text-white tracking-tight">$<?php echo e(number_format($closedRevenue, 0, '.', ' ')); ?></h3>
                </div>
                <!-- Neon line underneath -->
