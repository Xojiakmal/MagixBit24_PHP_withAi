<div class="h-full bg-transparent text-white pb-10">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-3xl font-bold text-white tracking-tight">Tashqi Kontaktlar</h2>
            <p class="text-dark-muted mt-1 text-sm">Kompaniya tashqarisidagi foydalanuvchilar va ma'lumotlar bazasi</p>
        </div>
    </div>
    ...
    <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="w-full md:w-1/4 space-y-6">
                <div class="bg-black/20 border border-dark-border rounded-[32px] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl">
                    <h3 class="text-xl font-bold mb-4">Guruhlar</h3>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="flex justify-between items-center bg-black/40 border border-white/5 p-3 rounded-xl cursor-pointer hover:border-accent transition-colors <?php echo e($activeGroupId === $group->id ? 'border-accent bg-accent/10' : ''); ?>" wire:click="setView('contacts', <?php echo e($group->id); ?>)">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button wire:click.stop="deleteGroup(<?php echo e($group->id); ?>)" class="text-gray-500 hover:text-red-400 p-1" onclick="confirm('Guruhni o\'chirish barcha ichidagi kontaktlarni ham o\'chirishi mumkin. Tasdiqlaysizmi?') || event.stopImmediatePropagation()">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditingGroup): ?>
                        <div class="mt-4 space-y-2">
                            <input type="text" wire:model.defer="groupName" placeholder="Guruh nomi (Masalan: Haydovchilar)" class="w-full bg-black/40 border border-dark-border rounded-xl px-3 py-2 text-white text-sm focus:border-accent outline-none">
                            <div class="flex space-x-2">
                                <button wire:click="saveGroup" class="flex-1 bg-accent hover:bg-accent-hover text-white text-sm py-1.5 rounded-lg transition-colors shadow-[0_0_15px_rgba(155,114,255,0.4)]">Saqlash</button>
                    ...
                    <div class="bg-black/20 border border-dark-border rounded-[32px] p-6 lg:p-8 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl min-h-[70vh]">
                        ...
                        <div class="flex justify-between items-center mb-8 border-b border-dark-border pb-4">
                            <div>
                                ...
                                <p class="text-sm text-dark-muted mt-1">Ushbu guruhdagi barcha kontaktlar va ularning maydonlari</p>
                            </div>
                            <div class="flex items-center space-x-1 bg-white/5 p-1 rounded-xl w-fit border border-dark-border">
                                <button wire:click="setView('contacts', <?php echo e($activeGroupId); ?>)" class="px-4 py-2 rounded-lg text-sm font-medium transition-colors <?php echo e($currentView === 'contacts' ? 'bg-white/10 text-white shadow-[0_0_10px_rgba(255,255,255,0.1)]' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">Ro'yxat</button>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentView === 'form_builder'): ?>
                            <div class="space-y-8">
                                <div>
                                    <h4 class="text-lg font-bold mb-4">Mavjud maydonlar</h4>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <!-- Default required fields -->
                                        <div class="bg-black/30 border border-dark-border p-4 rounded-xl flex justify-between items-center opacity-70">
                                            <div>
                                                <p class="font-semibold text-white">Ism-familiya <span class="text-red-400 ml-1">*</span></p>
                                                <p class="text-xs text-gray-500 mt-1">Majburiy asosiy maydon</p>
                                            </div>
                                            <span class="px-2 py-1 bg-white/5 rounded text-xs text-gray-400">string</span>
                                        </div>
                                        <div class="bg-black/30 border border-dark-border p-4 rounded-xl flex justify-between items-center opacity-70">
                                            <div>
                                                <p class="font-semibold text-white">Telefon raqam <span class="text-red-400 ml-1">*</span></p>
                                                <p class="text-xs text-gray-500 mt-1">Majburiy asosiy maydon</p>
                                            </div>
                                            <span class="px-2 py-1 bg-white/5 rounded text-xs text-gray-400">string</span>
                                        </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex items-center mt-2 space-x-2">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cf->type === 'select' && $cf->options): ?>
                                                            ...
                                                            <span class="text-xs text-blue-400" title="<?php echo e(implode(', ', $opts)); ?>"><?php echo e(count($opts)); ?> ta variant</span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>
                                                </div>
                                                <button wire:click="deleteCustomField(<?php echo e($cf->id); ?>)" class="text-gray-500 hover:text-red-400 opacity-0 group-hover:opacity-100 transition-opacity p-1" title="Maydonni o'chirish">
                                ...
                                <div class="bg-white/5 border border-white/10 rounded-2xl p-6">
                                    <h4 class="text-lg font-bold mb-4 text-accent">Yangi maydon qo'shish</h4>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-400 mb-1">Nomi</label>
                                            <input type="text" wire:model="newFieldName" placeholder="Masalan: Mashina turi" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div>
                                            ...
                                            <select wire:model.live="newFieldType" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none">
                                                <option value="string">Qisqa matn (String)</option>
                                                <option value="text">Katta matn (Text)</option>
                                                <option value="number">Raqam (Number)</option>
                                                <option value="date">Sana (Date)</option>
                                                <option value="boolean">Ha/Yo'q (Boolean)</option>
                                                <option value="select">Variantli (Select Option)</option>
                                            </select>
                                        </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($newFieldType === 'select'): ?>
                                            <div class="md:col-span-2">
                                                <label class="block text-sm font-medium text-gray-400 mb-1">Variantlar (vergul bilan ajrating)</label>
                                                <input type="text" wire:model="newFieldOptions" placeholder="Damas, Cobalt, Gentra, Tracker" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none">
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <div class="md:col-span-2 flex items-center justify-between mt-2 border-t border-dark-border pt-4">
                                            <label class="flex items-center space-x-3 cursor-pointer group">
                                                <input type="checkbox" wire:model="newFieldRequired" class="w-5 h-5 rounded border-white/20 bg-black/50 text-accent focus:ring-accent focus:ring-offset-0 focus:ring-2 focus:border-accent transition-all cursor-pointer">
                                                <span class="text-sm font-medium text-gray-300 group-hover:translate-x-0.5 transition-transform">Majburiy maydon</span>
                                            </label>
                        ...
                        <?php else: ?>
                            <div class="mb-6 flex justify-between items-center">
                                <h4 class="text-lg font-bold">Kontaktlar Ro'yxati</h4>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditingContact): ?>
                                <div class="bg-black/30 border border-dark-border rounded-2xl p-6 mb-8">
                                    <h4 class="text-lg font-bold mb-4"><?php echo e($contactId ? 'Kontaktni tahrirlash' : 'Yangi kontakt qo\'shish'); ?></h4>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <!-- Default Fields -->
                                        <div>
                                            <label class="block text-sm font-medium text-gray-400 mb-1">Ism-familiya <span class="text-red-500">*</span></label>
                                            <input type="text" wire:model="contactName" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-400 mb-1">Telefon raqam <span class="text-red-500">*</span></label>
                                            <input type="tel" wire:model="contactPhone" oninput="this.value = this.value.replace(/[^0-9\+\s]/g, '')" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <div class="<?php echo e($cf->type === 'text' ? 'md:col-span-2' : ''); ?>">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cf->type === 'text'): ?>
                                                    <textarea wire:model="dynamicFieldsData.<?php echo e($cf->id); ?>" rows="3" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none custom-scrollbar"></textarea>
                                                <?php elseif($cf->type === 'select'): ?>
                                                    <?php $opts = $cf->options ? json_decode($cf->options, true) : []; ?>
                                                    <select wire:model="dynamicFieldsData.<?php echo e($cf->id); ?>" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none">
                                                ...
                                                <?php elseif($cf->type === 'boolean'): ?>
                                                    <div class="flex space-x-4 mt-2">
                                                        <label class="flex items-center space-x-3 cursor-pointer group">
                                                            <input type="radio" wire:model="dynamicFieldsData.<?php echo e($cf->id); ?>" value="1" class="text-accent bg-black/40 border-white/20 focus:ring-accent focus:ring-offset-0 focus:ring-2 focus:border-accent transition-all cursor-pointer">
                                                            <span class="text-sm text-gray-300 group-hover:translate-x-0.5 transition-transform">Ha</span>
                                                        </label>
                                                        <label class="flex items-center space-x-3 cursor-pointer group">
                                                            <input type="radio" wire:model="dynamicFieldsData.<?php echo e($cf->id); ?>" value="0" class="text-accent bg-black/40 border-white/20 focus:ring-accent focus:ring-offset-0 focus:ring-2 focus:border-accent transition-all cursor-pointer">
                                                            <span class="text-sm text-gray-300 group-hover:translate-x-0.5 transition-transform">Yo'q</span>
                                                        </label>
                                                    </div>
                                                <?php elseif($cf->type === 'date'): ?>
                                                    <input type="date" wire:model="dynamicFieldsData.<?php echo e($cf->id); ?>" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none">
                                                <?php else: ?>
                                                    <input type="<?php echo e($cf->type === 'number' ? 'number' : 'text'); ?>" wire:model="dynamicFieldsData.<?php echo e($cf->id); ?>" class="w-full bg-black/40 border border-dark-border rounded-xl px-4 py-2 text-white focus:border-accent outline-none">
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="mt-6 flex space-x-3 justify-end border-t border-dark-border pt-4">
                                        <button wire:click="$set('isEditingContact', false)" class="px-5 py-2 bg-dark-surface hover:bg-white/5 border border-dark-border text-white text-sm font-semibold rounded-xl transition-colors">Bekor qilish</button>
                                        <button wire:click="saveContact" class="px-6 py-2 bg-accent hover:bg-accent-hover text-white text-sm font-semibold rounded-xl transition-colors shadow-[0_0_15px_rgba(155,114,255,0.4)]">Saqlash</button>
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="overflow-x-auto rounded-xl border border-dark-border">
                                <table class="w-full text-left text-sm text-gray-300">
                                    <thead class="bg-black/40 text-xs uppercase text-gray-400 border-b border-dark-border">
                                        <tr>
                                            <th class="px-4 py-3 font-semibold">Ism-familiya</th>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            <th class="px-4 py-3 font-semibold text-right">Amallar</th>
                                        </tr>
                                    </thead>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <tr class="hover:bg-white/5 transition-colors">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $customFields->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <td class="px-4 py-3 text-gray-400">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cf->type === 'boolean'): ?>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($val === '1'): ?> <span class="text-green-400">Ha</span> 
                                                            <?php elseif($val === '0'): ?> <span class="text-red-400">Yo'q</span>
                                                ...
                                                <td class="px-4 py-3 text-right">
                                                    ...
                                                    <button onclick="confirm('Kontaktni o\'chirmoqchimisiz?') || event.stopImmediatePropagation()" wire:click="deleteContact(<?php echo e($contact->id); ?>)" class="text-red-400 hover:text-red-300 p-1">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                                    </button>
                                                </td>
                                            </tr>
                ...
                <?php else: ?>
                    <div class="bg-black/20 border border-dark-border rounded-[32px] p-12 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl min-h-[70vh] flex flex-col items-center justify-center text-center">
                        ...
                        <h3 class="text-2xl font-bold text-white mb-2">Tashqi Kontaktlar</h3>
                        <p class="text-dark-muted max-w-md">Chap tarafdan kontakt guruhini tanlang yoki yangisini yarating.</p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
